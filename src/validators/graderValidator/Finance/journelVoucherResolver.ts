...
export const journelVoucherResolver = yupResolver(
  Yup.object().shape({
    ...
    totalDebit: Yup.number().required("Total Debit is Required"),
    totalCredit: Yup.number().required("Total Credit is Required"),
  })
);