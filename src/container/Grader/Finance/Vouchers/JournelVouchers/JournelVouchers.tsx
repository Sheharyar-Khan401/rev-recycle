...
export default function JournelVouchers() {
  ...
  const journelVouchers = result?.data?.payLoad;
  ...
  return (
    <div className="d-lg-flex">
      <VouchersSideNav type={5} />
      <div className="table-container">
        <Filters
          componentRef={ref}
          printAble={(journelVouchers && journelVouchers.length > 0) ?? false}
          exportAble={(journelVouchers && journelVouchers.length > 0) ?? false}
        ...
        {hasPermission("fin_v_103") && (
          <DataTable
            ...
            rows={
              journelVouchers
                ? journelVouchers?.map((item: Voucher) => {
