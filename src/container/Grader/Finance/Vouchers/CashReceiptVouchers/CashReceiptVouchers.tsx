...
export default function CashReceiptVouchers() {
  ...
  const cashReceiptVouchers = result?.data?.payLoad;
  ...
  return (
    <div className="d-lg-flex">
      <VouchersSideNav type={2} />
      <div className="table-container">
        <Filters
          componentRef={ref}
          addRedirectPath={hasPermission("fin_v_100") ? "add" : ""}
          printAble={
            (cashReceiptVouchers && cashReceiptVouchers.length > 0) ?? false
          }
          exportAble={
            (cashReceiptVouchers && cashReceiptVouchers.length > 0) ?? false
          }
        ...
        {hasPermission("fin_v_103") && (
          <DataTable
            ref={ref}
            tableTitle="Cash Receipt Vouchers"
            ...
            rows={
              cashReceiptVouchers
                ? cashReceiptVouchers?.map((item: Voucher) => {
