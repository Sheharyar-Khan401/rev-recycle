...
import { useLazyGetDailyProductionProfitReportsQuery } from "redux/features/sales/Reports/DailyProductionProfitApiSlice";
...
export default function DailyProductionProfitReports() {
  const ref = useRef<HTMLInputElement | null>(null);
  const [getReports, reportsData] =
    useLazyGetDailyProductionProfitReportsQuery();
    ...
    <>
      <div className="d-lg-flex">
        ...
        <div className="table-container">
            ...
            filters={[
              {
                ...
                name: "issuanceTypeId",
                inputType: "select",
                options: issuanceType
                  ? issuanceType?.map((issuanceType) => {
                      return {
                        text: issuanceType?.name ? issuanceType?.name : "",
                        value: issuanceType?.id ? issuanceType?.id : 0,
                      };
                    })
                  : [],
              },
          ...
          <DataTable
            ref={ref}
            tableTitle="Sales Daily Production Profit"
