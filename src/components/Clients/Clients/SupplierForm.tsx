...
export default function SupplierForm({ mode, isEdit, control, errors }: Props) {
  ...
  const payableAccDataList = (id: number) => {
    return data
      ? data?.map((account: Account) => {
          return {
            text: account?.accountTitle ? account?.accountTitle : "",
            value: account?.accountId ? account?.accountId : 0,
        ...
        <div className="col-lg-4 col-md-5 col-11 my-2">
          <Controller
            ...
            render={({ field: { onChange, value } }) => (
              <MDBSelect
                label="Git Account"
                inputClassName={errors.gitAccountId && "is-invalid"}
          ...
          />
          <FormValidationError errorMessage={errors.gitAccountId?.message} />
        </div>
      </div>
      <div className="row">
        <div className="col-lg-4 col-md-5 col-11 my-2">
        ...
        <div className="col-lg-4 col-md-5 col-11 my-2">
          <span className="me-5 pe-5 fw500">
            Record Finance <br /> Separately
          </span>
          <Controller
            control={control}
            name="recordFinanceSeparately"
            render={({ field: { onChange, value } }) => (
              <>
                <MDBRadio
                  label="Yes"
